...
function ChatBot() {
  ...
  return (
    <>
      {isOpen && (
        <div
          className="fixed bottom-24 right-6 w-96 h-[600px] bg-white dark:bg-zinc-900 rounded-lg shadow-xl border border-gray-200 dark:border-zinc-800 flex flex-col transition-all duration-300 ease-out"
          style={{
            opacity: isOpen ? 1 : 0,
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-blue-500 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-blue-600 transition-all duration-300 hover:scale-110 active:scale-90"
      >
        <LuBrain size={24} />
      </button>
    </>
